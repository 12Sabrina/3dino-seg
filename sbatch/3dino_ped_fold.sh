...
#SBATCH --output=/gpfs/share/home/2401111663/syy/3DINO-main-1/sbatch/output/ped/3dino-ped-%j.out
#SBATCH --error=/gpfs/share/home/2401111663/syy/3DINO-main-1/sbatch/error/ped/3dino-ped-%j.err
...
for FOLD in {1..5}; do
  ...
  JSON_OUT=$DATA_ROOT/dataset_ped_fold_${FOLD}.json
  OUTPUT_DIR="$BASE_DIR/training_runs/ped_fold${FOLD}"
  mkdir -p ${OUTPUT_DIR}

  echo "Starting PED fold ${FOLD}"
